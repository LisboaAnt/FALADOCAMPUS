    ...
    <section className="min-h-screen pt-12 pb-10">
      <div className="container mx-auto">
        ...
        <div className="mx-auto max-w-2xl sm:text-center">
          <Fade direction="up" delay={500} cascade damping={0.2} triggerOnce={true}>
        ...
        {/* Pricing Data */}
        <Fade direction="up" delay={600} cascade damping={0.2} triggerOnce={true}>
          <div className="mx-auto mt-16 max-w-2xl ring-1 ring-gray-200 rounded-3xl sm:mt-20 lg:mx-0 lg:flex lg:max-w-none backdrop-blur-md">
            {/* Left Section */}
